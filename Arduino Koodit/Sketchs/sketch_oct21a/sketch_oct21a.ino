...
void loop() 
{
  ...
  if (irrecv.decode(&results)) 
    ...
    //rele1
   if (results.value == 16720605)  // this is where you put in your IR remote button #
   
     {
      ...
      //rele2
      if (results.value == 16769055)  // this is where you put in your IR remote button #
   ...
   
     {
      ...
      //rele4
      if (results.value == 16724175)  // this is where you put in your IR remote button #
