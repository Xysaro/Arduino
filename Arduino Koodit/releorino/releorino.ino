...

{
  ...
  if (irrecv.decode(&results)) 
    ...
    //rele1
   if (results.value == Aota)  // this is where you put in your IR remote button #
   
     {
      ...
      //rele2
      if (results.value == Bota)  // this is where you put in your IR remote button #
   
     {
      ...
      //rele3
      if (results.value == Cota)  // this is where you put in your IR remote button #
   
     {
      ...
      //rele4
      if (results.value == Dota)  // this is where you put in your IR remote button #
